  ...
  sections: [
    {
      ...
      paragraphs: [
        `Search for "how to deposit at Aviator" and almost every result assumes you live in India or Bangladesh. They walk through UPI, PhonePe, bKash, and Nagad. Useful if you are in Mumbai or Dhaka. Useless if you are anywhere else. Almost none of them cover the six casinos we actually recommend for Aviator, and none combine deposit instructions, withdrawal process, KYC requirements, and crypto network choice in one place. Aviator itself is a <a href="https://spribe.co/games/aviator" target="_blank" rel="noopener noreferrer">crash game built by Spribe</a> using a provably fair algorithm, and the payment side is independent of the game side.`,
