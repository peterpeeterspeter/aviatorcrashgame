...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${SITE_URL}/aviator-tricks`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.8 },
    { url: `${SITE_URL}/aviator-app`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.7 },
    { url: `${SITE_URL}/aviator-live`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.7 },
    { url: `${SITE_URL}/aviator-max-win`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.7 },
    { url: `${SITE_URL}/aviator-no-deposit-bonus`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.8 },
    { url: `${SITE_URL}/aviator-free-spins`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.8 },
  ...
  const guidePages: MetadataRoute.Sitemap = guides.map((guide) => ({
    ...
    lastModified: guide.dateModified ?? new Date(),
    changeFrequency: "monthly",
    priority: 0.7,
  }));
